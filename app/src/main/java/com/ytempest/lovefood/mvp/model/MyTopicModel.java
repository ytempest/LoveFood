...
public class MyTopicModel extends BaseModel implements MyTopicContract.Model {
    @Override
    public Observable<BaseResult<DataList<TopicInfo>>> getMyTopicList(long userId, int pageNum, int pageSize) {
        return RetrofitClient.client().getService().getUserTopicList(userId, pageNum, pageSize)
